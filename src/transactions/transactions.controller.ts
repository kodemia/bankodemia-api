...
export class TransactionsController {
  ...
  @ApiOperation({
    ...
    description:
      'Make a `PAYMENT` to another user account or make a `DEPOSIT` to your own account',
  })
  @ApiBearerAuth()
  ...
  async create(
    ...
    if (
      ...
      throw new BadRequestException(
        `destinationUser is not required when performing a ${TransactionType.Deposit}`,
      );
    }
  ...
  @ApiOperation({
    ...
    description:
      'List the transaction that belongs to the user in the token provided along with the user balance',
  })
  @ApiBearerAuth()
  @UseGuards(JwtAuthGuard)
  @Get('me')
